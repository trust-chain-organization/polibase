...
The Python code (`src/config/config.py`) will automatically detect and use the main repository's .env file if a local .env doesn't exist.

For better performance, you can create a symbolic link:
```bash
