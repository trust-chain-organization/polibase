...
from src.database.speaker_matching_service import SpeakerMatchingService, SpeakerMatch
...
class TestSpeakerMatchingService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('src.database.speaker_matching_service.get_db_session') as mock_get_session:
    ...
    def test_rule_based_bracket_extraction(self):
        ...
        result = self.service._rule_based_matching('委員長(平山たかお)', available_speakers)
    ...
    def test_rule_based_symbol_removal(self):
        ...
        result = self.service._rule_based_matching('◆委員(下村あきら)', available_speakers)
    ...
    def test_rule_based_partial_match(self):
        ...
        result = self.service._rule_based_matching('総務部長(中野晋)', available_speakers)
    ...
    def test_filter_candidates(self):
        ...
        filtered = self.service._filter_candidates('委員長(平山たかお)', available_speakers, max_candidates=3)
