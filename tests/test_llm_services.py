...
from src.services import LLMService, PromptManager, ChainFactory
from src.services.llm_service import T
...
class TestLLMService:
    ...
    def test_create_advanced_instance(self):
        ...
        instance2 = LLMService(model_name=LLMService.DEFAULT_MODELS['advanced'], api_key="test-key", temperature=0.5)
...
class TestChainFactory:
    ...
    def test_create_generic_chain(self, mock_llm_service, mock_prompt_manager):
        ...
        chain = factory.create_generic_chain(
            template,
            output_schema=SampleTestSchema,
