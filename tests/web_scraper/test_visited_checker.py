...
from src.party_member_extractor.nodes.visited_checker import (
...
class TestCheckVisitedAndDepth:
    ...
    def test_new_url_within_depth_limit(self):
    ...
    def test_messages_added_to_state(self):
    ...
    def test_missing_state_fields_use_defaults(self):
...
class TestAddPendingUrlWithChecks:
    ...
    def test_add_new_url_within_depth(self):
    ...
    def test_skip_already_visited_url(self):
    ...
    def test_skip_url_beyond_max_depth(self):
    ...
    def test_url_at_max_depth_is_added(self):
    ...
    def test_multiple_urls_added(self):
    ...
    def test_messages_added_on_success(self):
...
class TestVisitedCheckerIntegration:
    ...
    def test_check_then_add_child_urls(self):
