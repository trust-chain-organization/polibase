...
class TestNormalizeUrl:
    ...
    def test_normalize_removes_fragment_with_query(self):
    ...
    def test_normalize_whitespace_only_url_raises_error(self):
        """Test that whitespace-only URL raises ValueError."""
        with pytest.raises(ValueError, match="URL cannot be empty"):
            normalize_url("   ")

    def test_normalize_invalid_url_no_scheme_raises_error(self):
        """Test that URL without scheme raises ValueError."""
        with pytest.raises(ValueError, match="Invalid URL format"):
            normalize_url("example.com/path")

    def test_normalize_invalid_url_no_host_raises_error(self):
    ...
    def test_normalize_japanese_path(self):
    ...
    def test_normalize_path_params(self):
...
class TestUrlNormalizerEdgeCases:
    ...
    def test_normalize_very_long_url(self):
    ...
    def test_normalize_url_with_special_chars_in_query(self):
    ...
    def test_normalize_different_schemes(self):
        """Test normalization with different URL schemes."""
        http_url = "http://example.com/path"
        https_url = "https://example.com/path"

        http_result = normalize_url(http_url)
        https_result = normalize_url(https_url)
    ...
    def test_normalize_url_deduplication_use_case(self):
        ...
        results = [normalize_url(url) for url in variations]
