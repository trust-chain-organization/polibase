...
class KaigirokuNetScraper(BaseScraper):
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                if pdf_url:
                    ...
                    # PDFをダウンロードして内容を返す
                    return await self._download_pdf_as_minutes(pdf_url, url, council_id, schedule_id)
    ...
    async def _download_pdf_as_minutes(self, pdf_url: str, original_url: str, 
                                     council_id: str, schedule_id: str) -> Optional[MinutesData]:
