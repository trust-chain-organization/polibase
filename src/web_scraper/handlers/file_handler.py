...
class FileHandler:
    ...
    def __init__(self, base_dir: str = "data/scraped", logger: Optional[logging.Logger] = None):
        self.base_dir = Path(base_dir)
        self.base_dir.mkdir(parents=True, exist_ok=True)
        self.logger = logger or logging.getLogger(__name__)
    
    def save_json(self, data: Dict[str, Any], filename: str, subdirs: Optional[List[str]] = None) -> str:
        """JSONデータを保存
    ...
    def save_text(self, content: str, filename: str, subdirs: Optional[List[str]] = None) -> str:
        """テキストデータを保存
    ...
    def create_date_subdirs(self, date: Optional[datetime] = None) -> List[str]:
    ...
    def generate_filename(self, council_id: str, schedule_id: str, extension: str) -> str:
        """標準的なファイル名を生成
    ...
    def list_files(self, pattern: str = "*", subdirs: Optional[List[str]] = None) -> List[Path]:
        """ファイルを一覧表示
