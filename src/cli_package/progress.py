...
@contextmanager
def spinner(message: str = "Processing", final_message: Optional[str] = None):
...
def progress_bar(iterable, label: str = "Processing", length: Optional[int] = None, 
                 fill_char: str = '█', empty_char: str = '░', width: int = 30):
...
def with_progress(message: str = "Processing", success_message: Optional[str] = None):
