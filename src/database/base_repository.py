...
"""
from typing import List, Dict, Optional, TypeVar, Generic, Any, Union
...
from src.config.database import get_db_session, get_db_engine
...
class BaseRepository:
    ...
    def fetch_one(self, query: str, params: Optional[Dict[str, Any]] = None) -> Optional[Any]:
        """
    ...
    def fetch_as_dict(self, query: str, params: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        """
    ...
    def update(self, table: str, data: Dict[str, Any], where: Dict[str, Any]) -> int:
        ...
        query = f"UPDATE {table} SET {set_clause}, updated_at = CURRENT_TIMESTAMP WHERE {where_clause}"
