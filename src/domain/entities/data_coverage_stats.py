"""Data coverage statistics entities for aggregation queries."""

from typing import TypedDict


class GoverningBodyStats(TypedDict):
    """Statistics for governing bodies coverage.
...
class SpeakerMatchingStats(TypedDict):
    """Statistics for speaker matching.
...
class ActivityData(TypedDict):
    """Activity data for a specific time period.
