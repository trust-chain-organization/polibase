...
-- 政令指定都市議会
('札幌市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '北海道札幌市' AND type = '市町村')),
('仙台市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '宮城県仙台市' AND type = '市町村')),
('さいたま市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '埼玉県さいたま市' AND type = '市町村')),
('千葉市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '千葉県千葉市' AND type = '市町村')),
('横浜市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '神奈川県横浜市' AND type = '市町村')),
('川崎市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '神奈川県川崎市' AND type = '市町村')),
('相模原市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '神奈川県相模原市' AND type = '市町村')),
('新潟市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '新潟県新潟市' AND type = '市町村')),
('静岡市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '静岡県静岡市' AND type = '市町村')),
('浜松市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '静岡県浜松市' AND type = '市町村')),
('名古屋市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '愛知県名古屋市' AND type = '市町村')),
('京都市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '京都府京都市' AND type = '市町村')),
('大阪市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '大阪府大阪市' AND type = '市町村')),
('堺市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '大阪府堺市' AND type = '市町村')),
('神戸市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '兵庫県神戸市' AND type = '市町村')),
('岡山市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '岡山県岡山市' AND type = '市町村')),
('広島市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '広島県広島市' AND type = '市町村')),
('北九州市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '福岡県北九州市' AND type = '市町村')),
('福岡市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '福岡県福岡市' AND type = '市町村')),
('熊本市議会', '市議会', (SELECT id FROM governing_bodies WHERE name = '熊本県熊本市' AND type = '市町村')),
